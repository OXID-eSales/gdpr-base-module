...
class oeGdprBaseProductRatingBridgeTest extends OxidTestCase
{
    ...
    {
        return new oeGdprBaseProductRatingBridge(
    ...
    {
        return new oeGdprBaseProductRatingService(
            $this->getRatingDaoMock(),
            $this->getProductRatingDao(),
            new oeGdprBaseRatingCalculatorService()
        );
    }
    ...
    private function getProductRatingDao()
    {
        ...
        return new oeGdprBaseProductRatingDao($database);
    }
    ...
    {
        $rating1 = new oeGdprBaseRating();
        $rating1->setRating(5);

        $rating2 = new oeGdprBaseRating();
        $rating2->setRating(4);

        $rating3 = new oeGdprBaseRating();
        $rating3->setRating(3);

        $ratingDaoMock = $this
            ->getMockBuilder('oeGdprBaseRatingDao')
