...
class oeGdprBaseProductRatingDaoTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @dataProvider invalidProductIdsProvider
     * @expectedException oeGdprBaseInvalidObjectIdDaoException
     *
     * @param $invalidProductId
     */
    public function testGetProductByIdWithInvalidId($invalidProductId)
    {
        $database = $this->getMockBuilder('Database')->getMock();
        $productRatingDao = new oeGdprBaseProductRatingDao($database);
